...
- **Session 2026-08-26** — Q: ¿Llegó la programación? → A: Sí, agenda oficial parcial. Talleres el **5 y 6** de noviembre (Casa Museo, entrada libre); conversatorios con horarios y temas definidos del 6 (3:00 p.m.) al 8 en Duruelo. Confirmados nuevos (además de los 3 previos): Jorge Cardona, Marisol Gómez, Luz María Sierra, Cecilia Orozco, Martha Ruiz, Guillermo González, Yolanda Ruiz, María Elvira Samper. Los "XXXX" del documento = por confirmar. María Jimena Duzán sigue confirmada (2026-08-25) sin franja asignada. Pendiente del organizador: credencial/medio y foto de cada panelista; grafías "Martha Ruiz" y "Guillermo González" por ratificar (el documento va en mayúsculas).
...
- **FR-004**: La página MUST presentar las secciones en este orden fijo: (1) Hero, (2) descripción corta + widget de compra en dos columnas, (3) La Oportunidad (primera edición: por qué esta ocasión es única — sin testimonios ni video de ediciones anteriores, que no existen), (4) Speakers, (5) Agenda, (6) Venue, (7) FAQs.
