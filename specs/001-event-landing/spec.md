...
- Q (2026-09-02): Ajustes de diseño del usuario → logo completo grande en el hero (el del header aparece al hacer scroll); serifada solo en énfasis deliberados (línea final del hero, cierre de El encuentro, cita de la banda azul); formulario con teléfono primero y sin texto repetido; agenda en formato tabla con botón de compra por franja (reemplaza el badge "Con boleta" y el CTA de cierre de Agenda de FR-010); la banda azul va de última, tras FAQs.
- Q (2026-09-09): Textos de CTA por sección (ajusta FR-010): el header y la franja del hero conservan "Comprar boletas"; el cierre de Panelistas dice "Quiero estar ahí", cada franja con boleta en la agenda "Asegurar mi boleta" y el cierre final tras FAQs "Vivir Testigos de la Memoria". Mismo estilo y mismo destino (#boletas); los textos viven en `ui.ts` y el componente solo acepta esas claves. El contador del hero muestra días, horas, minutos y segundos en vivo.
