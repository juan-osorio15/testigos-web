...
export const event = {
  ...
  description: {
    es: 'Los periodistas que cubrieron los últimos cincuenta años de Colombia cuentan y analizan, en persona, los hechos que vivieron de frente. Conversatorios y talleres en Villa de Leyva, del 5 al 8 de noviembre de 2026.',
    en: 'The journalists who covered the last fifty years of Colombia recount and analyze, in person, the events they witnessed firsthand. Talks and workshops in Villa de Leyva, November 5–8, 2026.',
...
export const venues: Venue[] = [
  {
    ...
    role: {
      es: 'Talleres de periodismo · entrada libre · 5 de noviembre',
      en: 'Journalism workshops · free entry · November 5',
    },
    mapsUrl:
  ...
  },
  {
    ...
    role: {
      es: 'Conversatorios · con boleta · 6 al 8 de noviembre',
      en: 'Conversations · ticketed · November 6–8',
    },
    mapsUrl:
